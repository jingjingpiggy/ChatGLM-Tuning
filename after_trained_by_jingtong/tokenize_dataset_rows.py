...
def read_jsonl(path, max_seq_length, chatglm_path, version='v1', skip_overlength=False):
    ...
    with open(path, "r") as f:
        for line in tqdm(f.readlines()):
            ...
            # print("----",example)
            #---- {'context': 'Instruction: Generate a comedic pun that involves the word "moon".\nAnswer: ', 'target': 'I was out of this world the other day until I realized I was really just on the moon.'}
